class HEX {
    ...
    BADC = s => { return s.match(/(.{4})/g).map(part => part.match(/(.{2})/g).reverse().join("")).join(""); };
    HexSpacer = s => {};
    ...
    _normalize() {
        ...
        if (this._HexText.length % 4) { this._HexText += "00"; }
        ...
        if (this._HexText.length % 8) { this._HexText += "0000"; }
    ...
    get getUint16AB() {
        ...
        return { hex: this._HexText.match(/(.{4})/g), value: arr };
    }
    ...
    get getUint16BA() {
        ...
        return { hex: this.BADC(this._HexText).match(/(.{4})/g), value: arr };
    }
    ///INT16 - Big Endian (AB)
    get getInt16AB() {
        let arr = [];
    ...
    get getUint32ABCD() {
        ...
        return { hex: this._HexText.match(/(.{8})/g), value: arr };
    }
    ...
    get getUint32BADC() {
        ...
        return { hex: this._HexText2.match(/(.{8})/g), value: arr };
    }
